...
out.print("youe account number ="+accountno);
...
String query="insert into account values('"+accountno+"','"+name+"','"+gender+"','"+address+"','"+contactno+"','"+emailaddress+"','"+panno+"','"+aadhar+"','"+balance+"','"+password+"','"+openingdate+"')";
